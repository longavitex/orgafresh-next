...
const MenuThree = () => {
    return (
        <>
            <div className='header-menu style-one md:h-[50px] h-[40px] bg-brown'>
                <div className="container mx-auto h-full">
                    <div className="header-main flex justify-between h-full relative">
                        <div className="shop-department basis-1/4 pr-8">
                            <div className="heading bg-orange text-white w-full h-full flex items-center pl-7 gap-3 cursor-pointer">
                                <Icon.List size={20} />
                                <p className='text-lg font-normal'>Shop by Department</p>
                            </div>
                        </div>
                        <div className="menu-main xl:absolute xl:left-1/2 xl:top-1/2 xl:-translate-x-1/2 xl:-translate-y-1/2 h-full max-lg:hidden pl-10">
