                    ...
                    <div className="header-main flex justify-between h-full relative">
                        ...
                        <div className="menu-main xl:absolute xl:left-1/2 xl:top-1/2 xl:-translate-x-1/2 xl:-translate-y-1/2 h-full max-lg:hidden">
                            <ul className='flex items-center gap-10 h-full'>
                                <li className='h-full relative'>
                                    <a href="#!" className={`text-button duration-300 h-full flex items-center justify-center gap-1 ${pathname.includes('/homepages/') ? 'active' : ''}`}>
                                        Home
                                    ...
                                    <ul className='absolute sub-menu bg-white duration-300'>
                                        ...
                                        <li>
                                            <Link href="/homepages/home3" className={`text-button duration-300 ${pathname === '/homepages/home3' ? 'active' : ''}`}>
                                                Home Grain & nuts
                                            </Link>
                                        </li>
                                    </ul>
                        ...
                        <div className="right-content flex gap-8">
                            ...
                            <div className="list-icon flex">
                                ...
                                <div
                                    className="max-[450px]:hidden wishlist-icon flex items-center justify-center md:pr-7 pr-4 relative cursor-pointer"
                                ...
                                <div
                                    className="max-[450px]:mr-1 cart-icon flex items-center justify-center relative cursor-pointer"
                                        ...
                                        <div className="sub-nav-mobile">
                                            ...
                                            <div className="list-nav-item w-full grid grid-cols-2 pt-2 pb-6">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <Link href="/homepages/home3" className={`nav-item-mobile link duration-300 active`}>
                                                            Home Grains & nuts
                                                        </Link>
                                                    </li>
                                                </ul>
