  ...
  return (
    <>
      <div className='header-menu style-one md:h-[80px] h-[60px]'>
        <div className="container 2xl mx-auto h-full">
          <div className="header-main flex justify-between h-full relative">
              ...
              <ul className='flex items-center gap-10 h-full'>
                <li className='h-full relative'>
                  ...
                  <ul className='absolute sub-menu bg-white duration-300'>
                    <li>
                      <Link href="/" className='text-button duration-300 text-green'>
                        Home Smoothies
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/home4" className='text-button duration-300'>
                        Home Cake
                      </Link>
                    </li>
                    <li>
                      <Link href="/home5" className='text-button duration-300'>
                        Home Grain & nuts
                      </Link>
                    </li>
                  </ul>
            ...
            <div className="right-content flex gap-6">
              ...
              <div className="list-icon flex">
                ...
                <div className="max-[450px]:hidden cart-icon flex items-center justify-center md:pl-7 md:pr-7 md:border-r pl-2.5 pr-2.5 border-line relative cursor-pointer">
