            ...
            <div className="cart-product md:py-20 py-12">
                <div className="container">
                    <div className="content-main flex justify-between">
                        <div className="left w-2/3 pr-16">
                            <div className="text-cate">Billing details</div>
                            <form className='grid grid-cols-2 gap-20 gap-y-16 mt-12'>
                        ...
                        <div className='right w-1/3 pl-4'>
